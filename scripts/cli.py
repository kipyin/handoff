"""Typer-based CLI entrypoint for running the Handoff app.

Use via: uv run handoff (or uv run handoff run)
For dev/build commands, use: uv run handoff-dev check | test | ci | build | ...
"""
